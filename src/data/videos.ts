...
const topicLessonVideoMap: Record<string, CourseVideo> = {
  ...
  "tp-self-attn": { id: "v-attn-main", youtubeId: "PSs6nxngL6k", title: "Attention for Neural Networks, Clearly Explained!!!", channel: "StatQuest with Josh Starmer", duration: "34 min" },
  ...
  "tp-sci-shadow": { id: "v-sci-shadow", youtubeId: "CoAPMSV3ghs", title: "Formation of Shadows | English", channel: "IISER Pune Science Activity Centre", duration: "8 min" },
  "tp-sci-shadow-l1": { id: "v-sci-shadow-l1", youtubeId: "CoAPMSV3ghs", title: "Formation of Shadows | English", channel: "IISER Pune Science Activity Centre", duration: "8 min" },
  "tp-sci-shadow-l2": { id: "v-sci-shadow-l2", youtubeId: "CoAPMSV3ghs", title: "Formation of Shadows | English", channel: "IISER Pune Science Activity Centre", duration: "8 min" },
  ...
  "tp-sst-dir": { id: "v-sst-dir", youtubeId: "ZOy7lOHs8TY", title: "How to use a basic Compass Rose - GEOGRAPHY BASICS", channel: "Mr B", duration: "8 min" },
  "tp-sst-dir-l1": { id: "v-sst-dir-l1", youtubeId: "ZOy7lOHs8TY", title: "How to use a basic Compass Rose - GEOGRAPHY BASICS", channel: "Mr B", duration: "8 min" },
  ...
  "tp-climate-zones": { id: "v-climate-main", youtubeId: "lrPS2HiYVp8", title: "Understanding Climate", channel: "Khan Academy", duration: "10 min" },
  "tp-climate-zones-l1": { id: "v-climate-l1", youtubeId: "lrPS2HiYVp8", title: "Understanding Climate", channel: "Khan Academy", duration: "10 min" },
  "tp-journal": { id: "v-acc-journal", youtubeId: "yKk_0q20KqE", title: "DOUBLE-ENTRY ACCOUNTING: Explained in (Almost) 2 Minutes!", channel: "Accounting Stuff", duration: "18 min" },
  "tp-journal-l1": { id: "v-journal-l1", youtubeId: "yKk_0q20KqE", title: "DOUBLE-ENTRY ACCOUNTING: Explained in (Almost) 2 Minutes!", channel: "Accounting Stuff", duration: "18 min" },
  "tp-demand": { id: "v-econ-demand", youtubeId: "FBWJYH8DZ1g", title: "Introduction to price elasticity of demand", channel: "Khan Academy", duration: "20 min" },
  "tp-demand-l1": { id: "v-demand-l1", youtubeId: "FBWJYH8DZ1g", title: "Introduction to price elasticity of demand", channel: "Khan Academy", duration: "20 min" },
  "tp-valuation": { id: "v-fin-valuation", youtubeId: "CfkFFk-r9aA", title: "Build a Discounted Cash Flow (DCF) Model in Excel | Step-by-Step Valuation Guide", channel: "Corporate Finance Institute", duration: "26 min" },
  "tp-valuation-l1": { id: "v-val-l1", youtubeId: "CfkFFk-r9aA", title: "Build a Discounted Cash Flow (DCF) Model in Excel | Step-by-Step Valuation Guide", channel: "Corporate Finance Institute", duration: "26 min" },
  ...
  "tp-lit-review": { id: "v-res-lit", youtubeId: "K6ZTbo8rOVg", title: "How To Search For Research Papers | LITERATURE REVIEW MADE EASY", channel: "Dr Amina Yonis", duration: "20 min" },
  "tp-lit-review-l1": { id: "v-lit-l1", youtubeId: "K6ZTbo8rOVg", title: "How To Search For Research Papers | LITERATURE REVIEW MADE EASY", channel: "Dr Amina Yonis", duration: "20 min" },
  ...
  "tp-writing": { id: "v-res-writing", youtubeId: "0EBiI1Agj2w", title: "Paper Structure and Content | Writing an Academic Paper", channel: "KPU Conferences", duration: "22 min" },
  "tp-writing-l1": { id: "v-writing-l1", youtubeId: "0EBiI1Agj2w", title: "Paper Structure and Content | Writing an Academic Paper", channel: "KPU Conferences", duration: "22 min" },
