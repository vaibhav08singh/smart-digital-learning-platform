...
export const defaultStudent: StudentProfile = {
  ...
  goals: ["Score 95%+ in BTech CSE Exams", "Master Data Structures & Algorithms step-by-step"],
  learningStreakDays: 12,
  overallProgress: 46,
  totalStudyMinutes: 3240,
  dailyGoalMinutes: 45,
  strongSubjectIds: ["sub-dsa", "sub-programming", "sub-algorithms", "sub-os"],
  weakSubjectIds: ["sub-dbms", "sub-networks"],
  preferredSubjectIds: ["sub-dsa", "sub-programming", "sub-dbms", "sub-os"],
  enrolledCourseIds: ["c-dsa-foundations", "c-deep-learning", "c-python-foundations", "c-cpp-foundations"],
  bookmarkedCourseIds: ["c-dsa-foundations", "c-deep-learning", "c-python-data-ai"],
};
